...
\section{Corrigendum}
  This section aims to correct the mistakes in the original textbook.
  
(III Proposition 9.7, 9.8) Need to assume $X, Y$ are Noetherian, since the theory of associated prime need the ring to be Noetherian.

(III Remark 12.4.1) $T$ should be assumed to commute with products instead of direct sums. Then the theory of Freyd's special adjoint functor theorem tells that $T$ is of the form Hom$(Q, \cdot)$.
